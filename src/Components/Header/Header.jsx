      ...
      <div className=" bg-[#55142A] w-full h-13 flex flex-col md:flex-row flex-wrap items-center space-x-20  justify-between px-6 p-3">
        <div>
          ...
          <img
            src={LogoImage}
            alt="Noor Logo"
            className="h-10 md:h-14 lg:h-8 w-auto object-contain"
          />
        </div>
        ...
        <div className="relative w-64 md:w-80">
          ...
          <input
            ...
            className="w-64 md:w-100 border border-[#FFF3E3] text-[#FFF3E3]  bg-transparent placeholder-[#FFF3E3] px-2 py-1 rounded"
          />
        </div>
